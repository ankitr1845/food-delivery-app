  ...
  return (
    <div className=' bg-slate-200 w-full min-h-screen'>
        ...
        {!input?<div className='flex flex-wrap justify-center items-center gap-5 w-[100%]'>
          {categories.map((item) =>{
             return(
              <div className='w-[140px] h-[150px] bg-white flex flex-col items-start justify-start gap-5 p-6 text-[16px] font-semibold text-gray-600
        ...
        <div className='w-full flex flex-wrap gap-5 px-5 justify-center items-center pt-8 pb-8'>
          ...
          )) : <div className='text-2xl text-red-500 font-semibold'>No item found ! </div>}
        ...
        ${showcart?"translate-x-0":"translate-x-full"} `}>
          ...
          <div className='w-full flex justify-between items-center p-9'>
              ...
              <button className='w-[80%] p-3 bg-green-500 rounded-lg text-white hover:bg-green-400 transition-all cursor-pointer'
              onClick={()=>toast.success("Order Placed Successfully !")}
              >Place Order</button>
              </>: <div className='text-center text-2xl text-red-500 font-bold pt-5 '>Empty Cart !!!</div>}
